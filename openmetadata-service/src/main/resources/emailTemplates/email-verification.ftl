                          ...
                          <tbody>
                            <tr>
                              <td class="tw-card-header" style="padding: 5px 5px px; width: 366px; color: #ffff; text-decoration: none; font-family: sans-serif;" align="center">
                                <span style="font-weight: 600;">Email Confirmation Required</span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td class="button__td " style="border-radius: 7px; text-align: center; width: 523px;">
                                                ...
                                                <!-- [if !mso]>
																									<!-->
                                                <a class="button__a" style="border-radius: 4px; color: #ffffff; display: block; font-family: sans-serif; font-size: 18px; font-weight: bold; mso-height-rule: exactly; line-height: 1.1; padding: 14px 18px; text-decoration: none; text-transform: none; border: 0;" href="${userEmailTokenVerificationLink}" target="_blank" rel="noopener">Confirm email</a>
                                                <!--![endif]-->
                                              </td>
                                            </tr>
                                          </tbody>

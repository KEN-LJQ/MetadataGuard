                            ...
                            <tr>
                              <td class="tw-card-body" style="padding: 20px 35px; text-align: left; color: #6f6f6f; font-family: sans-serif; border-top: 0;">
                                ...
                                <p class="" style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                  ...
                                  <br />
                                  <br />
                                  <span style="font-weight: 400;">Please use the following link to create a new password for <strong>${entity}</strong>. </span>
                                  <br />
                                          ...
                                          <tbody>
                                            <tr>
                                              <td class="button__td " style="border-radius: 7px; text-align: center; width: 523px;">
                                                ...
                                                <!-- [if !mso]>
																									<!-->
                                                <a class="button__a" style="border-radius: 4px; color: #ffffff; display: block; font-family: sans-serif; font-size: 18px; font-weight: bold; mso-height-rule: exactly; line-height: 1.1; padding: 14px 18px; text-decoration: none; text-transform: none; border: 0;" href="${userResetPasswordLink}" target="_blank" rel="noopener">Create Password</a>
                                                <!--![endif]-->
                                              </td>
                                            </tr>
                                          </tbody>

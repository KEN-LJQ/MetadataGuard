                          ...
                          <tbody>
                            <tr>
                              <td class="tw-card-header" style="padding: 5px 5px px; width: 366px; color: #ffff; text-decoration: none; font-family: sans-serif;" align="center">
                                <span style="font-weight: 600;">${entity} Invite</span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                            ...
                            <tr>
                              <td class="tw-card-body" style="padding: 20px 35px; text-align: left; color: #6f6f6f; font-family: sans-serif; border-top: 0;">
                                ...
                                <p class="" style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                  ...
                                  <br />
                                  <br />
                                  <span style="font-weight: 400;">You have been added as an admin. Please use below password to sign-in. Please change the password on signing in to <strong>${entity}</strong>. </span>
                                  <br />
                                  <br />
                                          ...
                                          <tbody>
                                            <tr>
                                              <td class="button__td " style="border-radius: 7px; text-align: center; width: 523px;">
                                                ...
                                                <!-- [if !mso]>
																									<!-->
                                                <a class="button__a" style="border-radius: 4px; color: #ffffff; display: block; font-family: sans-serif; font-size: 18px; font-weight: bold; mso-height-rule: exactly; line-height: 1.1; padding: 14px 18px; text-decoration: none; text-transform: none; border: 0;" href="${applicationLoginLink}" target="_blank" rel="noopener">Login</a>
                                                <!--![endif]-->
                                              </td>
                                            </tr>
                                          </tbody>
